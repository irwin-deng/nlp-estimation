...
def ci_experiment_repeated(snli_labeled: bool, bootstrap_size: str, seed: int = 0,
        results_save_path: Optional[str] = None, verbose: bool = False, debug: bool = False):
    """
...
if __name__ == '__main__':
    ...
    with torch.no_grad():
        ...
        ci_experiment_repeated(snli_labeled=True, bootstrap_size="unlabeled", results_save_path="results_unlabeled_snli-snli_mnli-finetuned.csv",
            seed=0, verbose=True, debug=False)
        ci_experiment_repeated(snli_labeled=False, bootstrap_size="unlabeled", results_save_path="results_unlabeled_mnli-snli_mnli-finetuned.csv",
            seed=0, verbose=True, debug=False)
        ci_experiment_repeated(snli_labeled=True, bootstrap_size="labeled", results_save_path="results_labeled_snli-snli_mnli-finetuned.csv",
            seed=0, verbose=True, debug=False)
        ci_experiment_repeated(snli_labeled=False, bootstrap_size="labeled", results_save_path="results_labeled_mnli-snli_mnli-finetuned.csv",
            seed=0, verbose=True, debug=False)

        bert_classifier.load_state_dict(torch.load("finetuned_snli.pt"))
        ci_experiment_repeated(snli_labeled=True, bootstrap_size="unlabeled", results_save_path="results_unlabeled_snli-snli_snli-finetuned.csv",
            seed=0, verbose=True, debug=False)
        ci_experiment_repeated(snli_labeled=False, bootstrap_size="unlabeled", results_save_path="results_unlabeled_mnli-snli_snli-finetuned.csv",
            seed=0, verbose=True, debug=False)
        ci_experiment_repeated(snli_labeled=True, bootstrap_size="labeled", results_save_path="results_labeled_snli-snli_snli-finetuned.csv",
            seed=0, verbose=True, debug=False)
        ci_experiment_repeated(snli_labeled=False, bootstrap_size="labeled", results_save_path="results_labeled_mnli-snli_snli-finetuned.csv",
            seed=0, verbose=True, debug=False)
